...
public class Form_Kategori extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        data_kategori.setBackground(new Color(255, 255, 255));
        ...
        jLabel3.setIcon(new ImageIcon(getClass().getResource("/Icons/Restaurant.png"))); // NOI18N
        ...
        GroupLayout data_kategoriLayout = new GroupLayout(data_kategori);
        data_kategori.setLayout(data_kategoriLayout);
        data_kategoriLayout.setHorizontalGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, data_kategoriLayout.createSequentialGroup()
                .addGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(GroupLayout.Alignment.LEADING, data_kategoriLayout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        data_kategoriLayout.setVerticalGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, data_kategoriLayout.createSequentialGroup()
                .addGap(16, 16, 16)
                .addGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jLabel5))
                .addGap(35, 35, 35)
                .addGroup(data_kategoriLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
        ...
        main_panel.add(data_kategori, "card2");

        tambah_kategori.setBackground(new Color(255, 255, 255));
        ...
        GroupLayout tambah_kategoriLayout = new GroupLayout(tambah_kategori);
        tambah_kategori.setLayout(tambah_kategoriLayout);
        tambah_kategoriLayout.setHorizontalGroup(tambah_kategoriLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
    ...
    private void btn_tambahActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btn_tambahActionPerformed
        ...
        main_panel.add(tambah_kategori);// Beralih ke panel tambah/edit
        main_panel.repaint();
        ...
        try {
            ...
            Logger.getLogger(Form_Kategori.class.getName()).log(Level.SEVERE, null, e);
        }
    ...
    private JPanel tambah_kategori;
 ...
 // pagination() - Mengatur fungsi pagination untuk Kategori
    ...
    private void showPanel() {
        ...
        main_panel.add(new Form_Kategori());// Menambahkan panel Form_Kategori ke panel utama
    ...
    private String setIDKategori() throws SQLException {
        ...
        try (PreparedStatement st = con.prepareStatement(sql)) {
            ...
            java.util.logging.Logger.getLogger(Form_Kategori.class.getName()).log(Level.SEVERE, null, e);
        }
        return urutan;
    }
